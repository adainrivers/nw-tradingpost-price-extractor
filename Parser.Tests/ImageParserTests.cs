...
namespace Parser.Tests
{
    public class ImageParserTests
    {
        ...
        public void FullImageTest(string imageFileName, string[] itemIds, decimal[] prices = null, int?[] gearScores = null, int[] availability = null, string[] locations = null)
        {
            ...
            var results = imageParser.Parse("eng", image);
