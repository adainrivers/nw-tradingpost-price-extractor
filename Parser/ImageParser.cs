...
namespace Parser
{
    public class ImageParser : IDisposable
    {
        ...
        public List<RawPriceData> Parse(string language, Image image)
        {
        ...
        {
            _tesseractForNumbers = TesseractFactory.Create(null, true);
            _tesseractForText = TesseractFactory.Create(language, false);
        }
        ...
        {
            _tesseractForNumbers.Options.PageSegmentation = PageSegmentation.Line;
